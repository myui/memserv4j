...
public final class AtomicUtils {
    ...
    public static int tryIncrementAndGetIfLessThan(final AtomicInteger capacity,
    ...
    public static int tryDecrementAndGetIfGreaterThan(final AtomicInteger capacity,
            final int least) {
        for (;;) {
            final int current = capacity.get();
            if (current <= least) {
