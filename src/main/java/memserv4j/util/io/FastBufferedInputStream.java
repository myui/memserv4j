...
public final class FastBufferedInputStream extends FilterInputStream {
     ...
     * as input after a <code>reset</code> operation. If <code>markpos</code> is not
     * <code>-1</code>, then all bytes from positions <code>buf[markpos]</code> through
     * <code>buf[pos-1]</code> must remain in the buffer array (though they may be moved to another
     * place in the buffer array, with suitable adjustments to the values of <code>count</code>,
     * <code>pos</code>, and <code>markpos</code>); they may not be discarded unless and until the
     * difference between <code>pos</code> and <code>markpos</code> exceeds <code>marklimit</code>.
     *
